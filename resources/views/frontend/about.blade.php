...
@section('content')
    ...
    @if (filled(trim(strip_tags($about['story'] ?? ''))))
        <section class="about-page-story section-space">
            <div class="site-shell about-page-story__shell {{ blank($about['story_title']) ? 'about-page-story__shell--content-only' : '' }}">
                @if ($about['story_title'])
                    <div class="about-page-story__heading" data-aos="fade-up">
                        <h2 class="display-title">{{ $about['story_title'] }}</h2>
                    </div>
                @endif
                <div class="article-prose about-page-story__body" data-aos="fade-up" data-aos-delay="100">
                    {!! $about['story'] !!}
                </div>
            </div>
        </section>
