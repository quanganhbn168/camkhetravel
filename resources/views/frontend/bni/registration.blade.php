...
@section('content')
    <div class="bni-plan">
        ...
        <section class="bni-registration-hero" aria-labelledby="bni-registration-title">
            ...
            <div class="site-container w-full max-w-7xl mx-auto px-4 lg:px-8 bni-registration-hero__content">
        ...
        <section id="form-dang-ky" class="bni-plan-section bni-registration-section" aria-labelledby="bni-registration-form-title">
            <div class="site-container w-full max-w-7xl mx-auto px-4 lg:px-8 bni-registration-layout">
