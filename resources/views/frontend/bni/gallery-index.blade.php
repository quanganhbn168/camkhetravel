...
@section('content')
    ...
    <section class="bni-gallery-hero">
        <div class="site-container w-full max-w-7xl mx-auto px-4 lg:px-8 bni-gallery-hero__content">
    ...
    <section class="bni-section bni-gallery-upload" id="gui-anh" aria-labelledby="bni-gallery-upload-title">
        <div class="site-container w-full max-w-7xl mx-auto px-4 lg:px-8 bni-gallery-upload__layout">
