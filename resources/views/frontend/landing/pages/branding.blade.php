<section class="branding-hero" aria-labelledby="branding-hero-title">
    ...
    <div class="branding-container mx-auto w-full max-w-7xl px-4 lg:px-8 relative branding-hero-inner">
        <div class="branding-hero-copy">
            <p class="branding-hero-brand">{{ $content['brand']['name'] }}</p>
            <p class="branding-tagline">{{ $content['brand']['tagline'] }}</p>
            ...
            <div class="branding-hero-pricing">
                <div class="branding-old-price"><span>TỔNG GIÁ TRỊ</span><s>{{ number_format(array_sum(array_column($content['services'], 'price')), 0, ',', '.') }}đ</s></div>
                <x-landing.branding-icon class="branding-price-arrow" />
                <div class="branding-gold-card"><span>ƯU ĐÃI CHỈ CÒN</span><strong>{{ number_format($content['offer']['price'], 0, ',', '.') }}đ</strong></div>
            </div>
...
<section id="dich-vu" class="branding-section branding-services">
    <div class="branding-container mx-auto w-full max-w-7xl px-4 lg:px-8 relative">
        <div class="branding-section-heading">
            <div><p class="branding-kicker">DỊCH VỤ TRONG GÓI</p><h2>4 GIẢI PHÁP TOÀN DIỆN CHO DOANH NGHIỆP</h2></div>
    ...
    <div class="branding-container mx-auto w-full max-w-7xl px-4 lg:px-8 relative">
        ...
        <div class="branding-combo-grid grid lg:grid-cols-2">
            <div class="branding-price-table">
                ...
                @endforeach
                <div class="branding-table-total"><span>Tổng giá trị</span><s>{{ number_format(array_sum(array_column($content['services'], 'price')), 0, ',', '.') }}đ</s></div>
            </div>
            <div class="branding-combo-offer">
                <div class="branding-gold-card"><span>ƯU ĐÃI ĐẶC BIỆT CHỈ CÒN</span><strong>{{ number_format($content['offer']['price'], 0, ',', '.') }}đ</strong></div>
...
<section id="du-an" class="branding-section branding-projects">
    <div class="branding-container mx-auto w-full max-w-7xl px-4 lg:px-8 relative">
        <div class="branding-section-heading"><div><p class="branding-kicker">DỰ ÁN TIÊU BIỂU</p><h2>NHỮNG THƯƠNG HIỆU ĐÃ TIN TƯỞNG THT MEDIA</h2></div><a class="branding-button branding-button-outline" href="{{ route('projects.index') }}">Xem thêm dự án <x-landing.branding-icon /></a></div>
        <div class="branding-four-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
