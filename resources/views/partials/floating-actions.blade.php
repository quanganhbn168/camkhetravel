<div class="position-fixed d-grid dv-floating-actions__div-1" aria-label="Liên hệ nhanh">
    @if ($website->hotline)
    ...
    @if ($website->zalo_url)
        <a class="floating-action floating-action--zalo" href="{{ $website->zalo_url }}" target="_blank" rel="noopener noreferrer" aria-label="Nhắn Zalo">
            <img class="dv-floating-actions__media-2" src="{{ asset('images/zalo.svg') }}" alt="">
        </a>
    @endif
</div>
