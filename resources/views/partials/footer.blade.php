    ...
    <div class="site-shell grid gap-10 pb-12 sm:grid-cols-2 lg:grid-cols-[1.35fr_1fr_1fr_1.35fr] lg:gap-8">
        <div class="lg:pr-7">
            ...
            <div class="mt-7 flex items-center gap-2">
                ...
                @endif
                @if ($website->zalo_url)
                    <a class="footer-social text-[0.58rem] font-extrabold tracking-[-0.08em]" href="{{ $website->zalo_url }}" target="_blank" rel="noopener noreferrer" aria-label="Zalo">Zalo</a>
                @endif
        ...
        <div>
            ...
            <div class="mt-5 grid gap-3 text-sm leading-6">
                ...
                @if ($website->hotline)<a class="flex gap-3 hover:text-white" href="tel:{{ preg_replace('/\s+/', '', $website->hotline) }}"><svg class="mt-1 size-4 shrink-0 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.12 4.2 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.33 1.78.62 2.64a2 2 0 0 1-.45 2.11L8 9.75a16 16 0 0 0 6 6l1.28-1.28a2 2 0 0 1 2.11-.45c.86.29 1.74.5 2.64.62A2 2 0 0 1 22 16.92Z"/></svg><span>{{ $website->hotline }}</span></a>@endif
