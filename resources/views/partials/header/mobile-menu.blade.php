<aside class="offcanvas offcanvas-end mobile-menu" tabindex="-1" id="mobile-drawer" aria-labelledby="mobile-drawer-title">
            ...
            @foreach ($headerNavigation as $item)
                <div class="mobile-nav__item">
                    <div class="d-flex align-items-center">
                        <a class="mobile-nav__link flex-grow-1 @if ($item['is_active']) is-active @endif"
                        ...
                        @if ($item['has_children'])
                            <button class="mobile-nav__toggle" type="button" data-bs-toggle="collapse"
