<a class="header__brand" href="{{ route('home') }}" aria-label="{{ $website->site_name }}">
                @if ($headerLogoUrl)
                    <img src="{{ $headerLogoUrl }}" alt="{{ $website->site_name }}" >
                @else
                    ...
                    <span class="brand__words"><strong>{{ $website->site_name }}</strong><small>{{ $website->company_name }}</small></span>
                @endif
            </a>
