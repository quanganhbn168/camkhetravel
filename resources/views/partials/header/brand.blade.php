...
<a class="site-header__brand" href="{{ LocalizedUrl::route('home') }}" aria-label="{{ $website->site_name }}">
                @if ($headerLogoUrl)
                    <img src="{{ $headerLogoUrl }}" alt="{{ $website->site_name }}" class="site-header__logo">
                @else
                    <span class="site-brand__symbol" aria-hidden="true">
                    ...
                    <span class="site-brand__words"><strong>{{ $website->site_name }}</strong><small>{{ $website->company_name }}</small></span>
                @endif
            </a>
