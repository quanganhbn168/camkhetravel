...
return new class extends Migration
{
    public function up(): void
    {
        ...
        throw_if(empty($tableNames), Exception::class, 'Permission configuration is not loaded.');
        throw_if($teams && empty($columnNames['team_foreign_key'] ?? null), Exception::class, 'Permission team configuration is incomplete.');
