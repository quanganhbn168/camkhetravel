...
class LocalizedUrl
{
    ...
    private static function fallbackUrl(string $name, array $parameters): string
    {
        $paths = [
            ...
            'about' => 'gioi-thieu',
            'bni.events.index' => 'le-chuyen-giao/su-kien',
            'bni.events.show' => 'le-chuyen-giao/su-kien/'.($parameters['event'] ?? ''),
            'bni.handover' => 'le-chuyen-giao',
            'bni.registrations.create' => 'le-chuyen-giao/dang-ky',
            'bni.registrations.store' => 'le-chuyen-giao/dang-ky',
